...
2 초	128 MB	214607	47905	36919	22.494%
문제
...
def count_point(x1, y1, r1, x2, y2, r2):
    # 두 원의 중심 사이의 거리 계산
    d = math.sqrt((x2 - x1)**2 + (y2 - y1)**2)
    
    # 두 원이 일치하는 경우 (이론상 무한대의 교점, 실제 구현에서는 특별 처리)
    if d == 0 and r1 == r2:
        return -1  # 무한대의 교점을 의미
...
def main():
    ...
    for i in range(T):
        ...
        print(count_point(x1, y1, r1, x2, y2, r2))
